...
import 'package:map_app/view/drawer/custom_drawer_info.dart';

// import 'package:map_app/view/footer/footer.dart';

class AppearanceInfo extends StatelessWidget {
  const AppearanceInfo({super.key});
  @override
