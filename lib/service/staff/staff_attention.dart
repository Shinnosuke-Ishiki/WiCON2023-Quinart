...
import 'package:map_app/view/drawer/staff/custom_drawer_staff_attention.dart';

class StaffAttention extends StatelessWidget {
  const StaffAttention({super.key});
  @override
...
class AttentionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        drawer: const CustomDrawerStaffAttention());
  }
}
